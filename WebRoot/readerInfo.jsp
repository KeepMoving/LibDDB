...
A:HOVER{
	...
	<form action="updateReader.action" method="post" >
		...
		<tr>
			<td><div align="left"><span>证件号码(不可更改)</span></div></td>
			<td><input name="cardNo" value="${readerObj.cardNo}" size=25 maxsize=25 type="text" readonly="true"/></td>
		</tr>
		<tr>
			...
			<tr>
			<td><div align="left"><span>读者姓名(不可更改)</span></div></td>
			<td><input name="readerName" value="${readerObj.readerName}" size=25 maxsize=25 type="text" readonly="true"/></td>
		</tr>
				<tr>
			<td><div align="left"><span>性别(不可更改)</span></div></td>
			<td><input name="sex" value="${readerObj.sex}" size=25 maxsize=25 type="text" readonly="true"/></td>
		</tr>
				<tr>
