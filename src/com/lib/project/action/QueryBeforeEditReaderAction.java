...
public class QueryBeforeEditReaderAction extends ActionSupport {
	...
	public String execute() throws Exception {
		System.out.println("================Get a certain reader================");
		...
		if(readerObj != null)
		{
			...
			return "queryBeforeEditReaderSuccess";
		}
		else
		{
			return "QueryBeforeEditReaderFail";
		}
	}
}
