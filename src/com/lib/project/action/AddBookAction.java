...
public class AddBookAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		System.out.println("================Check the bookID================");
		bookTemp = bookService.getBookByBookID(bookID);
		if(bookTemp != null)
			return "BookIDExist";
		
		System.out.println("================Check the barcode================");
		bookTemp = bookService.getBookByBarcode(barCode);
		if(bookTemp != null)
			return "BarCodeExist";
		...
		bookData.setAddTime(addTime);
		bookData.setAuthor(author);
		bookData.setBarCode(barCode);
		bookData.setIndexNo(indexNo);
		bookData.setIsbn(isbn);
		bookData.setLocation(location);
		bookData.setOperator(operator);
